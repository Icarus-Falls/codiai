...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-[#000000] border-b border-zinc-900 sticky top-0 z-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="bg-zinc-100 text-black text-xs font-bold px-4 py-2 rounded-full hover:bg-[#0AC4E0] hover:text-[#0D1A63] transition-all duration-300"
